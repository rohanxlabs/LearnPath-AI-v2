...
export default function App() {
  ...
  const themeClass = settings.theme === 'dark' ? 'dark text-white' : 'light text-slate-900';
  const customBackground = settings.theme === 'dark' ? { backgroundColor: '#0A0A0A' } : { backgroundColor: '#F8FAFC' };
